    ...
    public ManufacturingDashboardDto getDashboardData() {
        ...
        List<ManufacturingAlertDto> alerts = List.of(
                ManufacturingAlertDto.builder()
                        ...
                        .severity("CRITICAL")
                        .message("Schuler Stamping Press 500T operating temperature exceeded 94.8°C (threshold: 90.0°C).")
                        .machineCode("PRESS-301")
                        .status("ACTIVE")
                        .timestamp("12m ago")
                        .build(),
                ManufacturingAlertDto.builder()
                        ...
                        .category("Vibration Spike")
                        .severity("WARNING")
                        .message("KUKA Robotic Weld-Arm 4 vibration increased to 4.8 mm/s on Joint 3.")
                        .machineCode("WELD-204")
                        .status("ACKNOWLEDGED")
                        .timestamp("45m ago")
                        .build(),
                ManufacturingAlertDto.builder()
                        ...
                        .title("Peak Energy Tariff Notice")
